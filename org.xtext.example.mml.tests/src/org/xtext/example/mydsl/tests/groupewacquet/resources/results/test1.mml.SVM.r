...
model <- svm(class~., data=dataTrain, type="C-classification", kernel="linear", cost=1.0, cross=10)
...
print(RECALL)
fileToWrite <- file("src/org/xtext/example/mydsl/tests/groupewacquet/resources/results/rfiles/test1.mml.SVM.txt")
